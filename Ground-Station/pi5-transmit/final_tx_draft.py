...
class Packet:
    ...
    def pack(self):
        return struct.pack(
            "<fffffffffddHH",
            float(self.altitude),
            float(self.orientationX),
            float(self.orientationY),
            float(self.orientationZ),
            float(self.velocityX),
            float(self.velocityY),
            float(self.velocityZ),
            float(self.battery_voltage),
            float(self.time_since_startup),
