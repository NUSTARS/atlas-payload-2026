...
// no constructor
KalmanFilterWN::KalmanFilterWN() : initialized(false)
{ 
}
...
void KalmanFilterWN::update(Eigen::Vector<float,2> z) {
...
void KalmanFilterWN::update_timestep(float dt) {
